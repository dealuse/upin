            ...
            <div class="box-content">
				...
				-->
					...
					<div class="field">
						...
						<span class="hint">出现在首页</span>
					</div>
                                        <div class="field">
						<label>商品指示语</label>
						<input type="text" size="30" name="product_ind" id="team-create-product" class="f-input" value="<?php echo $team['product_ind']; ?>" />
						<span class="hint">首页名称下方</span>
					</div>
					<div class="field">
						<label>购买必选项</label>

            ...
            <div class="box-content">
                ...
                <div class="sect">
					...
					<!-- Alipay -->
                        ...
                        <div class="field">
                            <label>商户ID号</label>
                            <input type="text" size="30" name="alipay[mid]" class="f-input" style="width:200px;" value="<?php echo $INI['alipay']['mid']; ?>"/><span class="inputtip">商户申请：<a href="http://act.life.alipay.com/systembiz/zuitu/" target="_blank"><font color="red">最土免费签约支付宝</font></a></span>
                        </div>
                        <div class="field">
                            <label>交易密钥</label>
                        ...
                        <div class="field">
                            <label>交易类型</label>
							<select name="alipay[guarantee]" class="f-input" style="width:160px;"><?php echo Utility::Option($option_guarantee, $INI['alipay']['guarantee']); ?></select><span class="inputtip">支付宝担保交易／即时到帐交易 / 双功能</span>
						</div>
                        <div class="field">
                            <label>成交条件</label>
                    ...
                    <!-- gopay -->
                        ...
                        <div class="field">
                            <label>商户代号</label>
                            <input type="text" size="30" name="gopay[mid]" class="f-input" value="<?php echo $INI['gopay']['mid']; ?>" style="width:200px;"/><span class="inputtip">商户申请：<a href="http://www.zuitu.com/value_gopay.html">签约国付宝支付</a></span>
                        </div>
                        <div class="field">
                            <label>国付宝账号</label>
                        ...
                        <div class="field">
                            <label>网银直连</label>
							<select name="gopay[direct]" class="f-input" style="width:200px;"><?php echo Utility::Option($option_yn, $INI['gopay']['direct']); ?></select>
							<span class="inputtip">直接显示网银支付选项</span>
                        </div>
					<!-- gopay/End -->
					<!-- other -->

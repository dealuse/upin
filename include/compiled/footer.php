...
<footer id="footer">
    ...
    <div class="container fs12">
        <ul class="inline">
            ...
            <li>
                <dl>
                    ...
                    <dd>
                        <a href="http://weibo.com/u/5264226494">新浪微博</a>
                    </dd>
                </dl>
            </li>
            <li>
            ...
            <li class="last">
                <p class="tc"><?php echo $INI['system']['kefutel']; ?></p>
                <p>工作时间：09:00-18:00（周一至周六 )</p>
                <!--<p class="weekend">9:00-18:00 ( 周日 )</p>-->
                <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;投诉：info@dealuse.com</p>
                <!--
        ...
        <p class="tc mt20">Copyright © 2014 <a href="">upin technology Inc</a> All Rights Reserved </p>
    </div>
</footer>
<!--<div class="two-code-left" style="background:none; border:none;">
 <a href="/zc/jiameng.php" target="_blank"><img src="/static/v2/img/jiameng_ad.gif" alt="">

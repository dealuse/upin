...
<!--top -->
<div id="etop">
<div id="welcome"><strong style="float:left;">优品会&nbsp;</strong><span style="float:left;font-size:20px;margin-top:24px;">www.dealuse.com</span></div>
<div id="welcome">祝您消费愉快！</div>
</div>
<!--endtop -->
<div id="teamtitle"><?php echo $team['product']; ?></div>
<!--main -->
<div id="main">
...
<img src="/qrcode.php?id=<?php echo $coupon['id']; ?>&sec=<?php echo $coupon['secret']; ?>" alt="二维码信息" />
</div>
